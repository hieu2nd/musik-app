...
import com.example.awesome.databinding.FragmentSportDetailBinding
 ...
 * Use the [FragmentSportDetail.newInstance] factory method to
...
class FragmentSportDetail : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val binding = FragmentSportDetailBinding.bind(view);
        sportViewModel.currentSport.observe(this.viewLifecycleOwner){
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentSportDetail.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentSportDetail().apply {
